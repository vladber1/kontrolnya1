...
def calculate(path2file):
    with open(path2file,'r', encoding='utf-8',newline='\n') as f:
        ...
        for i in l.splitlines():
            ...
            b=eval(a)
            print(b)
calculate('C:\\Users\\khodo\\Downloads\\text.txt')
...
substring_slice('C:\\Users\\khodo\\Downloads\\test_import_file1.txt',"C:\\Users\\khodo\\Downloads\\test_import_file2.txt")
...
def decode_ch(string):
    with open('C:\\Users\\khodo\\Downloads\\periodic_table.json','rb') as f:
        data= json.load(f)    
